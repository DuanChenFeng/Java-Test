	...
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
		    ...
		    <ul class="layui-nav layui-layout-right">
		      	<li class="layui-nav-item">
		        	<a href="javascript:;">
		          		<img src="<%=basePath %>/static/images/face/5.gif" class="layui-nav-img">
		        		${USER_SESSION.name}
		        	</a>
		        	<dl class="layui-nav-child">
		          		<dd><a href="">基本资料</a></dd>
		    		...
		    		<div class="layui-row">
		    			...
		    			<div class="layui-col-md5" >
		    				<input type="text" style="font: '微软雅黑'; font-size: large" 
		    					class="form-control" 
		    					value="${sys.current_time}" readonly="true"/>
		    			</div>
		    		</div>
    				<br /><br />
		    		<div class="layui-row">
		    			...
		    			<div class="layui-col-md5" >
		    				<input type="text" style="font: '微软雅黑'; font-size: large" 
		    					class="form-control" 
		    					value="${sys.run_time}" readonly="true"/>
		    			</div>
		    		</div>
		    		<br /><br />
		    		<div class="layui-row">
		    			...
		    			<div  class="layui-col-md5" >
		    				<input type="number" style="font: '微软雅黑'; font-size: large" 
		    					class="form-control" 
		    					value="${sys.user_num}" readonly="true"/>
		    			</div>
		    		</div>
		    		<br /><br />
		    		<div class="layui-row">
		    			...
		    			<div class="layui-col-md5" >
		    				<input type="number" style="font: '微软雅黑'; font-size: large" 
		    					class="form-control" 
		    					value="${sys.load_avg}" readonly="true"/>
		    			</div>
		    		</div>
    			</div>
  			</div>
