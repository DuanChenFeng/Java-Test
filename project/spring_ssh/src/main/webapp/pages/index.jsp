...
<body class="layui-layout-body">
	...
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree ">
					<li class="layui-nav-item layui-nav-itemed"><a class=""
						...
						<dl class="layui-nav-child" id="myTab">
							<dd class="active">
								<a href="#system_info" role="tab">系统信息</a>
							</dd>
							<dd>
								<a href="<%=basePath%>/index/taskinfo">任务进程信息</a>
							</dd>
							<dd>
								<a href="#cpu_info" role="tab">cpu状态信息</a>
							</dd>
							<dd>
		...
		<div class="layui-body">
	    	<!-- 内容主体区域 -->
 			<div style="padding: 15px;" class="layui-tab-item layui-show" id="system_info">
				<div class="layui-row">
		    		<div class="layui-row">
		    			<div class="layui-col-md2">
		    				<p align="right" style="font: '微软雅黑'; font-size: x-large">当前系统时间：</p>
		    			</div>
		    			<div class="layui-col-md5" style="font: '微软雅黑'; font-size: x-large">
		    				<input type="text" class="form-control" 
		    					value="${systemInfo.current_time}" readonly="true"/>
		    			</div>
		    		</div>
    				<br /><br />
		    		<div class="layui-row">
		    			<div class="layui-col-md2">
		    				<p align="right" style="font: '微软雅黑'; font-size: x-large">已运行时间：</p>
		    			</div>
		    			<div class="layui-col-md5" style="font: '微软雅黑'; font-size: x-large">
		    				<input type="text" class="form-control" 
		    					value="${systemInfo.run_time}" readonly="true"/>
		    			</div>
		    		</div>
		    		<br /><br />
		    		<div class="layui-row">
		    			<div class="layui-col-md2">
		    				<p align="right" style="font: '微软雅黑'; font-size: x-large">当前用户数：</p>
		    			</div>
		    			<div class="layui-col-md5" style="font: '微软雅黑'; font-size: x-large">
		    				<input type="number" class="form-control" 
		    					value="${systemInfo.user_num}" readonly="true"/>
		    			</div>
		    		</div>
		    		<br /><br />
		    		<div class="layui-row">
		    			<div class="layui-col-md2">
		    				<p align="right" style="font: '微软雅黑'; font-size: x-large">平均负载：</p>
		    			</div>
		    			<div class="layui-col-md5" style="font: '微软雅黑'; font-size: x-large">
		    				<input type="number" class="form-control" 
		    					value="${systemInfo.load_avg}" readonly="true"/>
		    			</div>
		    		</div>
    			</div>
  			</div>
  			<div style="padding: 15px;" class="layui-tab-item" id="cpu_info">
				<div class="layui-progress layui-progress-big ">
 					<div>
	  					<div class="layui-progress-bar" lay-percent="${cpuInfo.sys_cpu}%"></div>
 					</div>
				</div>
				<br/>
				<div class="layui-progress layui-progress-big">
  					<div class="layui-progress-bar" lay-percent="${cpuInfo.free_cpu}%"></div>
				</div>
  			</div>
  		</div>
	  	<!-- 底部固定区域 -->
